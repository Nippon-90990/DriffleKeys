                ...
                <div className="flex-1 flex flex-col justify-between min-w-0">
                  <div>
                    <div className="flex justify-between items-start  gap-2">
                      ...
                      {item.gift_tag && (<span className="bg-[#ff7f6a] px-2.5 py-1 rounded font-medium text-white mr-5 mt-5">{item.gift_tag}</span>)}
                      {item.game_tag && (<span className="bg-[#5539cc] px-2.5 py-1 rounded font-medium text-white mr-5 mt-5">{item.game_tag}</span>)}
                    ...
                    <span className="text-[#0099ff] text-sm font-extrabold uppercase mt-2.5 inline-block">GLOBAL</span>
                  </div>
